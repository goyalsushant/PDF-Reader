...
function printRows() {
  ...
  if (pageString.length != 0) {
    pageString = pageString.replace('TEC,HNOLOGY', 'TECHNOLOGY');
    pageString = pageString.replace('ADMINISTRA,TION', 'ADMINISTRATION');
    pageString = pageString.replace('ENGINE,ERS', 'ENGINEERS');
    pageString = pageString.replace('CERTIFICATI,ON', 'CERTIFICATION');
